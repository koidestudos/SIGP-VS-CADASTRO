...
export function countByStatus(programacoes) {
  const labels = {
    ...
    'Aguardando aprovação da Gerência': { label: 'Aguardando Gerência', color: '#ca8a04' },
    'Reenviada para análise': { label: 'Reenviadas', color: '#C2410C' },
    'Devolvida para correção': { label: 'Devolvidas', color: '#dc2626' },
    'Aprovada pela Gerência': { label: 'Aprovadas pela Gerência', color: '#168821' },
